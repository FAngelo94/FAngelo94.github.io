...
export const it: Translations = {
  ...
  home: {
    ...
    paragraphs: [
      "Hai bisogno di uno sviluppatore web full-stack per il tuo team.",
      "Devi migliorare il tuo sito/applicazione con nuove funzionalità.",
      "Hai bisogno di qualcuno che sviluppi tutto il software della tua startup da zero.",
      "Vuoi una consulenza per la tua idea prima di iniziare lo sviluppo.",
      "Hai bisogno di formazione specifica su tecnologie o metodologie di sviluppo web.",
