...
export const hero = {
  ...
  smallResume:
    "Web developer focused on Javascript, React, Python and SQL to develop both frontend and backend applications",
  contacts: "Contacts",
};
  ...
  jobs: [
    {
      ...
      whereAndWhen: "Remote, 09/2022 - Present",
    },
    {
...
export const projects = {
  ...
  projects: [
    ...
    // Diva
    {
      ...
      mainSkills: ["React", "Typescript", "RXjs", "JS", "Storybook"],
      allSkills: [
        "React",
        "Typescript",
        "Vanilla JS",
